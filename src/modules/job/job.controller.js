...
router.post('/addJob', authentication(), authorization(roleTypes.user), validation(validators.addJob), jobServices.addJob)
...
router.delete('/deleteJob/:jobId', authentication(), authorization(roleTypes.user), validation(validators.deleteJob), jobServices.deleteJob)
...
router.get('/getApplications/:jobId', authentication(), authorization(roleTypes.user), validation(validators.getAllApplications), jobServices.getAllApplications)

router.patch('/acceptOrRejectApplicant/:applicationId', authentication(), authorization(roleTypes.user), validation(validators.acceptOrRejectApplicant), jobServices.acceptOrRejectApplicant)
